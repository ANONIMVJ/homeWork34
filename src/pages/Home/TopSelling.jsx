  ...
  return (
    <div className='container'>
        ...
        <div className='item-cards'>
            <div className='card'>
              <img style={{width: "295px"}} src="/src/assets/img/ts1_item.png" alt="The item one png" />
            ...
            <div className='card'>
              <img style={{width: "295px"}} src="/src/assets/img/ts2_item.png" alt="The item two png" />
            ...
            <div className='card'>
              <img style={{width: "295px"}} src="/src/assets/img/ts3_item.png" alt="The item two png" />
            ...
            <div className='card'>
              <img style={{width: "295px"}} src="/src/assets/img/ts4_item.png" alt="The item two png" />
