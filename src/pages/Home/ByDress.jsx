      ...
      <div className='dress-wrapper'>
        ...
        <div className='img-wrapper'>
          <div className='img-row'>
            <img style={{width: "408px", height: "289px"}} src="/src/assets/img/bd1_item.png" alt="bd1" />
            <img style={{width: "684px", height: "289px"}} src="/src/assets/img/bd2_item.png" alt="bd2" />
          </div>
          <div className='img-row'>
            <img style={{width: "684px", height: "289px"}} src="/src/assets/img/bd3_item.png" alt="bd3" />
            <img style={{width: "408px", height: "289px"}} src="/src/assets/img/bd4_item.png" alt="bd4" />
          </div>
        </div>
      </div>
