  ...
  return (
    <div className='container'>
        ...
        <div className='item-cards'>
            <div className='card'>
              <img src="/src/assets/img/na1_item.png" alt="The item one png" />
            ...
            <div className='card'>
              <img src="/src/assets/img/na2_item.png" alt="The item two png" />
            ...
            <div className='card'>
              <img style={{width: "295px"}} src="/src/assets/img/na3_item.png" alt="The item two png" />
              <p>CHECKERED SHIRT</p>
              <div className='stars'>
                <BiSolidStar className='star-icon'/>
                <BiSolidStar className='star-icon'/>
            ...
            <div className='card'>
              <img style={{width: "295px"}} src="/src/assets/img/na4_item.png" alt="The item two png" />
